...
train_data = open("seq2seq_autoencoder/data/train_data.txt", 'w')
val_data = open("seq2seq_autoencoder/data/val_data.txt", 'w')

train_data_path = []
val_data_path = []

for dir in tqdm(glob.glob("seq2seq_autoencoder/data/json_data/train/*")):
    train_data_path.append(dir)

for dir in tqdm(glob.glob("seq2seq_autoencoder/data/json_data/val/*")):
    val_data_path.append(dir)

partition = json.loads(open("seq2seq_autoencoder/data/partition_128.json").read())
