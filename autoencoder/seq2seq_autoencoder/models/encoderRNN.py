...
class EncoderRNN(BaseRNN):
    ...
    def __init__(self, vocab_size, max_len, hidden_size,
        ...
        self.rnn = self.rnn_cell(embedding_size+50, hidden_size, n_layers,
    ...
    def forward(self, input_var, input_partition, input_lengths=None):
        ...
        #embedded = self.embedding(input_var) + self.part_embedding(input_partition)
        embedded = torch.cat((self.embedding(input_var), self.part_embedding(input_partition)), dim=2)
